(function($){
	$.fn.advancedtable = function(custom) {
		...
		function redrawTable() {
			...
			// Info block
			var blockInfo = '<div class="tableInfo">Exibindo ' + startRow + ' - ' + endEow + ' de ' + tableRows + '</div>';
		...
		function setActivePage(number){
			...
			table.find('.tableInfo').html("Exibindo " + (from + 1) + " - " + ((tableRows < to) ? tableRows : to) + " de " + tableRows);
