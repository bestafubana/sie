...
class ContatosControllerTest < ActionController::TestCase
  ...
  test "should create contato" do
    assert_difference('Contato.count') do
      post :create, :contato => { :departamento => @contato.departamento, :email => @contato.email, :empresa => @contato.empresa, :id => @contato.id, :nome => @contato.nome, :telefone => @contato.telefone }
    end
  ...
  test "should update contato" do
    put :update, :id => @contato, :contato => { :departamento => @contato.departamento, :email => @contato.email, :empresa => @contato.empresa, :id => @contato.id, :nome => @contato.nome, :telefone => @contato.telefone }
    assert_redirected_to contato_path(assigns(:contato))
  end
